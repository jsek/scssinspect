...
astToCSS = function(options) {
  var _composite, _m_composite, _m_delimited, _m_primitive, _m_simple, _simple, _suppressed, _t, _unique, hasInfo, index, syntax, tree;
  _t = function(tree) {
    var e, t;
    t = tree[index(0)];
    try {
      ...
      } else if (indexOf.call(Object.keys(_m_delimited), t) >= 0) {
        return _composite(tree) + ';';
