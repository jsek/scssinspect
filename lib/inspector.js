...
Inspector = (function(_super) {
  ...
  Inspector.prototype.run = function() {
    var contents, err, filePath, opts, _i, _len, _ref;
    opts = {
      encoding: 'utf8'
    };
    this.emit('start');
  ...
  Inspector.prototype._getHashKey = function(ruleset) {
    ...
    ruleset.pos = "(" + ruleset[0].ln + ", " + ((_ref = ruleset[0].end) != null ? _ref.ln : void 0) + ")";
    ruleset.loc = {
      start: {
        line: ruleset[0].ln
      },
      end: {
        line: (_ref1 = ruleset[0].end) != null ? _ref1.ln : void 0
      }
    };
    return structure;
  };
