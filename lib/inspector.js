var EventEmitter, Inspector, Match, __log, astToCSS, chalk, fs, parse, util,
...
Inspector = (function(superClass) {
  ...
  Inspector.prototype._insert = function(rule) {
    ...
    if (this._doesExceedThreshold(key)) {
      if (!this._hash[key]) {
        this._hash[key] = [];
      }
  ...
  Inspector.prototype._doesExceedThreshold = function(hash) {
    var tokensLength;
...
__log = function(x) {
  return console.log(chalk.cyan(x));
};
